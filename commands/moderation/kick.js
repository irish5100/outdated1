  ...
  run: async (client, message, args) => {
    ...
    if (!message.member.hasPermission("KICK_MEMBERS"))
      return message.channel.send(
        `You Don't Have Permission To Use This Command Idiot!`
      );
    ...
    if (Member.id === message.guild.owner.user.id)
      return message.channel.send(`You Can't Kick Irish`);
    ...
    try {
      ...
      let embed = new Discord.MessageEmbed()
        ...
        .setImage(`https://c.tenor.com/lzeoLQIX-Q8AAAAd/bette-midler-danny-devito.gif`)
      ...
      return message.channel.send(`I Can't Kick That Member Maybe Member Has Higher Role Than Me & My Role Is Lower Than Member!`)
